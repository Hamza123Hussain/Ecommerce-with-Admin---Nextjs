...
export default function Productitem({ product }: { product: Product }) {
  ...
  return (
    <>
      <div className="bg-white cursor-pointer w-72 sm:w-full shadow-[0_2px_15px_-6px_rgba(0,0,0,0.2)]  py-6 max-w-sm rounded-lg font-[sans-serif] overflow-hidden mx-auto mt-4">
